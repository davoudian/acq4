...
class Ui_MultiPatch(object):
    def setupUi(self, MultiPatch):
        ...
        self.gridLayout.addWidget(self.recordBtn, 8, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.matrixWidget, 0, 3, 11, 1)
